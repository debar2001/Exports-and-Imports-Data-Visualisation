---
title: "Imports and Exports of India: Make in India movement (Dashboard-1)"
output: 
...
### Choropleth for Export Data

```{r}
export_graph = plot_geo(dataset_df, 
                        locationmode = 'ISO-3',
                        frame = ~Year)%>%
...
### Choropleth for Import Data

```{r}
import_graph = plot_geo(dataset_df, 
                        locationmode = 'ISO-3',
                        frame = ~Year)%>%
  add_trace(locations = ~countries.Code,
            z = ~Import,
